...
Работайте в своей копии репозитория. Если практика предлагает несколько вариантов запуска, укажите выбранный вариант. Все команды и запросы должны быть выполнены на вашей базе MongoDB.
...
Положите в `lesson_03/screens/` шесть PNG или JPG. Текст команды и результата должен быть читаемым; на кадре должно быть понятно, какая программа запущена.
...
Дополнительные кадры разрешены. Не показывайте пароли и секретные данные.
...
> Обязательно добавьте шесть скриншотов в папку `lesson_03/screens/` и проверьте, что ссылки в этом файле ведут на реальные изображения.
